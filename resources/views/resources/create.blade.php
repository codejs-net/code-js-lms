...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{ route('create_resource') }}"><i class="fa fa-folder-open"></i> {{__('Resources')}}&nbsp;</a></li>
    <li class="breadcrumb-item active" ><a><i class="fa fa-plus"></i> {{__('Add Resources')}}&nbsp;</a></li>
</ol>
</nav>
    ...
    <div class="card card-body">
         ...
         <div class="col-md-12">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                        <label for="book_title">{{__('Resource Title')}}</label>
                        <input type="text" class="form-control mb-1" id="resource_title_si" name="resource_title_si" value="{{old('resource_title_si')}}" placeholder="{{__('Title in sinhala')}}" >
                        <input type="text" class="form-control mb-1" id="resource_title_ta" name="resource_title_ta" value="{{old('resource_title_ta')}}" placeholder="{{__('Title in Tamil')}}" >
                        <input type="text" class="form-control mb-1" id="resource_title_en" name="resource_title_en" value="{{old('resource_title_en')}}" placeholder="{{__('Title in English')}}" >
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                     ...
                     <div class="form-group col-md-3">
                        ...
                        <input type="value" class="form-control" name="resource_price"  value="{{old('resource_price')}}" placeholder="{{__('Resource price')}}:"required>
                ...
                <div class="form-row border border-secondary bg-light">
                   <div class="form-group col-md-12 col-12 p-2 mt-2">
                    <label for="note">{{__('Resource Center:')}}</label>
               ...
               <hr>
                ...
                <div class="form-check mb-2">
                    ...
                    <label class="form-check-label" for="check_place">{{__('Set Resource Placement Later')}}</label>
                </div>
