    ...
    <div class="card card-body">
        <div class="row text-center">
            <div class="col-md-10 col-sm-6 text-center"> 
                <h4> <i class="fa fa-object-group"></i>&nbsp;Resource Creator</h4>
            </div>  
            ...
            <table class="table table-hover table-bordered" id="book_datatable">
                    ...
                    @foreach ($details as $data)
                        <tr>
                            ...
                            <a class="btn btn-danger text-white" data-toggle="modal" data-target="#data_delete" data-detail_id="{{ $data->id }}" data-detail_name="{{ $data->$name }}"><i class="fa fa-trash" ></i>&nbsp;Delete</a>
                            @endcan
