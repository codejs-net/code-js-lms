            ...
            <table class="table table-hover table-bordered" id="book_datatable">
                    ...
                    @foreach ($details as $data)
                        <tr>
                            ...
                            <a class="btn btn-sm btn-outline-success " data-toggle="modal" data-target="#data_show" data-detail_id="{{ $data->id }}" data-detail_name="{{ $data->$language }}"><i class="fa fa-eye" ></i>&nbsp;Show</a>
                            @can('resource_support_data-edit')
                            <a class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#data_update" data-detail_id="{{ $data->id }}" data-detail_name_si="{{ $data->language_si }}" data-detail_name_ta="{{ $data->language_ta }}" data-detail_name_en="{{ $data->language_en }}"><i class="fa fa-pencil" ></i>&nbsp;Edit</a>
                            @endcan
                            @can('resource_support_data-delete')
                            <a class="btn btn-sm btn-outline-danger " data-toggle="modal" data-target="#data_delete" data-detail_id="{{ $data->id }}" data-detail_name="{{ $data->$language }}"><i class="fa fa-trash" ></i>&nbsp;Delete</a>
                            @endcan
                ...
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-12">
                            ...
                            <h5 class="text-indigo"><span>Language : &nbsp;</span><span id="name_show"></span></h5>
                        </div>
                    </div> 
                </div>
...
<div class="modal fade" id="data_create" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('resource_language.store') }}"class="needs-validation"  novalidate>
                {{ csrf_field() }}
                <div class="modal-body">

                    <div class="row form-group">
                        <label for="book_detail">Language</label>
...
<div class="modal fade" id="data_update" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('update_resource_language') }}"class="needs-validation"  novalidate>
                {{ csrf_field() }}
                <div class="modal-body">
...
<div class="modal fade" id="data_delete" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('delete_resource_language')}}">
                {{ csrf_field() }}
                <div class="modal-body">
...
<div class="modal fade" id="data_import" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form method="POST" method="POST" enctype="multipart/form-data" action="{{ route('import_resource_language') }}"class="needs-validation"  novalidate>
                {{ csrf_field() }}
                <div class="modal-body">
