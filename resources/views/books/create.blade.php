...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" ><a><i class="fa fa-plus"></i> Add Book&nbsp;</a></li>
</ol>
</nav>
...
<div class="container-fluid">
    <div class="row text-center">
        <div class="col-md-11 col-sm-6 text-center"> 
            <h4> <i class="fa fa-plus-circle"> {{__("Add Book")}}</i></h4>
        </div>  
...
<div class="container bg-white">
    <div class="card-body">
         ...
         <div class="col-md-12">
                ...
                <form action="{{ route('books.store') }}" method="post" name="book_save" id="book_save" class="needs-validation"  novalidate>
                {{ csrf_field() }}
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="isbn" name="isbn"  value="{{old('isbn')}}"  placeholder="ISBN"required>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control mb-1" id="authors_si" name="authors_si" value="{{old('authors_si')}}" placeholder="Author in Sinhala" >
                        <input type="text" class="form-control mb-1" id="authors_ta" name="authors_ta" value="{{old('authors_ta')}}" placeholder="Author in Tamil" >
                        <input type="text" class="form-control mb-1" id="authors_en" name="authors_en" value="{{old('authors_en')}}" placeholder="Author in English" >
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control" id="phymedium" name="phymedium" value="{{old('phymedia')}}"required>
                        <option value="" selected disabled hidden>Choose here</option>
                    ...
                    <div class="form-group col-md-2">
                    <label for="new_phymedium">New Physical Medium</label> </br>
