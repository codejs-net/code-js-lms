...
class CreateLendingView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        return <<<SQL
            CREATE ALGORITHM=UNDEFINED DEFINER=CURRENT_USER() SQL SECURITY DEFINER VIEW view_lending_data AS
    ...
    {
        return <<<SQL
            DROP VIEW IF EXISTS `view_lending_data`;
        SQL;
    }
}
